        ...
        <form action="{{route('jobs.update',$job->id)}}" method="post" >
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="dashboard-list-box margin-top-0">
                        ...
                        <div class="dashboard-list-box-content">
                            <div class="submit-page">
                                ...
                                <div class="form">
                                    <h5>Job Title</h5>
                                    <input class="search-field" name="job_title" type="text" placeholder=""
                                           value="{{$job->job_title??''}}"/>
                                </div>
                                ...
                                <div class="form">
                                    <div class="select">
                                        <h5>Category</h5>
                                        <select data-placeholder="Choose Categories" name="majors"
                                                class="chosen-select">
                                            @foreach($majors as $major)
                                                <option
                                                    @if($major->id=$job->majors_id )){{"selected='selected'"}}@endif value="{{$major->id}}"> {{$major->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form" style="width: 100%;">
                                    ...
                                    <textarea class="WYSIWYG" name="requirements" cols="40" rows="3" id="requirements"
                                              spellcheck="true">{{$job->requirements}}</textarea>
                                </div>
                                <!-- Description -->
                                <div class="form" style="width: 100%;">
                                    <h5>Benefits</h5>
                                    <textarea class="WYSIWYG" name="benefits" cols="40" rows="3" id="benefits"
                                              spellcheck="true">{{$job->benefits}}</textarea>
                                </div>
                                <!-- Application email/url -->
                                <div class="form">
                                    <h5>Application email / URL</h5>
                                    <input type="text" name="job_url" value="{{$job->url}}"
                                ...
                                <div class="form">
                                    ...
                                    <input data-role="date" name="date_expire" value="{{$job->date_expire}}" type="text"
                    ...
                    {{--            <a href="#" type="submit" class="button margin-top-30">Preview <i class="fa fa-arrow-circle-right"></i></a>--}}
                    <button type="submit">Save <i class="fa fa-arrow-circle-right"></i></button>
                </div>
